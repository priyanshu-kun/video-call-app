...
function NotFound() {
			...
			<div class="svgcontainer">
				<div class="subcont">
					<div class="topconvo">
						<span>!@#$</span>
						<br />
						<h1>your portal gun must be busted...</h1>
					</div>
					<svg version="1.1" id="fourohfour" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px"
    ...
    c3.8-4.6,6.7-6.1,8.5-7.2c3.4-2.1,7-3.1,10.7-2.8c5.7,0.4,10.8,2.1,15.4,5.1s7.7,6.8,9.4,11.4" />
					...
					<Link style={{ display: 'inline-block', padding: "10px", margin: '1rem 0 0 0', border: "1px solid purple", borderRadius: '10px' }} to="/">Back to Home page</Link>
				</div>
			</div >
